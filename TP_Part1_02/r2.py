...
HOST = '10.10.4.2' # local host
PORT = 31338       # PORT to read the message
...
while True:
    data = s.recv(1024) # receive the message and simply send to the destination as designated port (31338)
    ...
    if not data:
        break
    sendsock.sendto(data, ('10.10.5.2', 31338)) # sends the message to destination through port 31338